...
with sync_playwright() as p:
    browser = p.chromium.launch(headless=True)  # set to True if you don't want browser UI
    page = browser.new_page()
    page.goto("https://www.patagonia.com/shop/mens")
    page.pause()

    try:
        # Wait for the products to load
        page.wait_for_selector(".product-tile__image.default.active", timeout=60000)
